...
public class PieFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (bundle != null)
        {
            ...
            Log.i("string arrayList in pie",s.toString());

        }


        ArrayList<Entry> list=new ArrayList<Entry>();
        PieDataSet pieDataSet=new PieDataSet(list,"yList");
        pieDataSet.addEntry(new Entry(Integer.parseInt(s.get(c++)),0));
        ...
        PieData pieData=new PieData(theDates,pieDataSet);
